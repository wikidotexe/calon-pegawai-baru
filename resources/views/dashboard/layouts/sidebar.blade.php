<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-0 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-r-2xl border-0 bg-white p-0 antialiased shadow-lg transition-transform duration-200 xl:left-0 xl:translate-x-0">
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-dark" href="{{ route('dashboard') }}">
            <img src="{{ asset('img/blpbeauty.png') }}" class="inline h-full max-w-full max-h-12 rounded-full transition-all duration-200 ease-nav-brand" alt="main_logo" />
            <span class="ml-3 mb-2 font-semibold transition-all duration-200 ease-nav-brand">BLP Team</span>
        </a>
    </div>
    ...
    <ul class="flex flex-col pl-0 mb-5">
        ...
        <li class="w-full mt-6">
            <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-xs opacity-60">Data Master</h6>
        </li>
